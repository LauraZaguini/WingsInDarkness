...
draw_text(__view_get( e__VW.XView, 0 ),__view_get( e__VW.YView, 0 )+600-32-16*3,string_hash_to_newline("Copy your 0-Day Start values to this current day END values (Press D)"));
